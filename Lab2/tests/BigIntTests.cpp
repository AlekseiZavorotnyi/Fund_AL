...
TEST(FurieTest, multFurie) {
    ...
    EXPECT_EQ(multFurie_result, BigInt("1219326311370217952278038215903537062453797116414450938033431075752599906674667809347485350701542825"));
}

TEST(FurieTest, multFurie2) {
    ...
    BigInt multFurie_result = num1.multFurie(num2);
    EXPECT_EQ(multFurie_result, BigInt("37358383570383923042439837069931124234930192162309024405728049392171435551838411321293920182073243100906028436395515312933754872883286391064126248540093112447894021939657894633447620177109925"));
}
